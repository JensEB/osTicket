...
$ost->addExtraHeader('<script type="text/javascript" src="js/ticket.js?'.GIT_VERSION.'"></script>');
$ost->addExtraHeader('<script type="text/javascript" src="js/thread.js?'.GIT_VERSION.'"></script>');

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT_PATH ?>css/thread.css?<?php echo GIT_VERSION; ?>" media="all"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH ?>scp/css/scp.css?<?php echo GIT_VERSION; ?>" media="all"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/redactor.css?<?php echo GIT_VERSION; ?>" media="screen"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH ?>css/typeahead.css?<?php echo GIT_VERSION; ?>" media="screen"/>
    ...
    <!--[if IE 7]>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/font-awesome-ie7.min.css?<?php echo GIT_VERSION; ?>"/>
    <![endif]-->
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH ?>scp/css/dropdown.css?<?php echo GIT_VERSION; ?>"/>
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/loadingbar.css?<?php echo GIT_VERSION; ?>"/>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH ?>scp/css/translatable.css?<?php echo GIT_VERSION; ?>"/>
    <!-- Favicons -->

...
?>
<script type="text/javascript" src="js/raphael-min.js?<?php echo GIT_VERSION; ?>"></script>
<script type="text/javascript" src="js/g.raphael.js?<?php echo GIT_VERSION; ?>"></script>
<script type="text/javascript" src="js/g.line-min.js?<?php echo GIT_VERSION; ?>"></script>
<script type="text/javascript" src="js/g.dot-min.js?<?php echo GIT_VERSION; ?>"></script>
<script type="text/javascript" src="js/dashboard.inc.js?<?php echo GIT_VERSION; ?>"></script>

<link rel="stylesheet" type="text/css" href="css/dashboard.css?<?php echo GIT_VERSION; ?>"/>

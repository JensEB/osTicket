...
<head>
	...
	<link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/osticket.css?<?php echo GIT_VERSION; ?>" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css?<?php echo GIT_VERSION; ?>" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/print.css?<?php echo GIT_VERSION; ?>" media="print"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/typeahead.css?<?php echo GIT_VERSION; ?>"
         media="screen" />
    <link type="text/css" href="<?php echo ROOT_PATH; ?>css/ui-lightness/jquery-ui-1.13.2.custom.min.css?<?php echo GIT_VERSION; ?>"
        rel="stylesheet" media="screen" />
    <link rel="stylesheet" href="<?php echo ROOT_PATH ?>css/jquery-ui-timepicker-addon.css?<?php echo GIT_VERSION; ?>" media="all"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/thread.css?<?php echo GIT_VERSION; ?>" media="screen"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/redactor.css?<?php echo GIT_VERSION; ?>" media="screen"/>
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/font-awesome.min.css?<?php echo GIT_VERSION; ?>"/>
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/flags.css?<?php echo GIT_VERSION; ?>"/>
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/rtl.css?<?php echo GIT_VERSION; ?>"/>
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/select2.min.css?<?php echo GIT_VERSION; ?>"/>
    <!-- Favicons -->
    <link rel="icon" type="image/png" href="<?php echo ROOT_PATH ?>images/oscar-favicon-32x32.png" sizes="32x32" />
    <link rel="icon" type="image/png" href="<?php echo ROOT_PATH ?>images/oscar-favicon-16x16.png" sizes="16x16" />
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/jquery-3.7.0.min.js?<?php echo GIT_VERSION; ?>"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/jquery-ui-1.13.2.custom.min.js?<?php echo GIT_VERSION; ?>"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/jquery-ui-timepicker-addon.js?<?php echo GIT_VERSION; ?>"></script>
    <script src="<?php echo ROOT_PATH; ?>js/osticket.js?<?php echo GIT_VERSION; ?>"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/filedrop.field.js?<?php echo GIT_VERSION; ?>"></script>
    <script src="<?php echo ROOT_PATH; ?>js/bootstrap-typeahead.js?<?php echo GIT_VERSION; ?>"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/redactor.min.js?<?php echo GIT_VERSION; ?>"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/redactor-plugins.js?<?php echo GIT_VERSION; ?>"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/redactor-osticket.js?<?php echo GIT_VERSION; ?>"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/select2.min.js?<?php echo GIT_VERSION; ?>"></script>
<!-- Anpassung Anfang: help-topic-drop-down (jsTree) -->

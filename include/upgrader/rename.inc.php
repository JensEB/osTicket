...
<div id="upgrader">
    ...
    <div id="main">
            ...
            <p><?php echo sprintf(__('Please refer to the %1$s Upgrade Guide %2$s for more information.').' (en)', '<a target="_blank" href="https://docs.osticket.com/en/latest/Getting%20Started/Upgrade%20and%20Migration.html">', '</a>');?></p>
            <div id="bar">

...
<!-- Anpassung Ende -->
        ...
        <p><?php echo sprintf(__('Please feel free to %1$s let us know %2$s of any other improvements and features you would like to see in osTicket, so that we may add them in the future as we continue to develop better and better versions of osTicket.'), '<a target="_blank" href="https://osticket.com.de/support/">', '</a>');?></p>

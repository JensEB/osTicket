...
?>
    <div id="main">
            ...
            <p><?php echo sprintf(__('If sample config file is missing - please make sure you uploaded all files in \'upload\' folder or refer to the %1$s Installation Guide %2$s').' (en)','<a target="_blank" href="https://docs.osticket.com/en/latest/Getting%20Started/Installation.html">','</a>');?></p>
            <div id="bar">
